...
# Jangan biarkan import/inisialisasi Bot bikin app crash.
# ===========================================================
...
# ABSOLUTE import untuk logic bot (src/bot-api/bot.py); aman jika file belum ada
try:
...
# ===========================================================
# Kamu memilih ENDPOINT GLOBAL -> gunakan format URL: /translate?api-version=3.0
...
async def translate(req: TranslateRequest):
    ...
    # ✅ KARENA MEMAKAI ENDPOINT GLOBAL:
    #    https://api.cognitive.microsofttranslator.com/
    #    path yang benar adalah /translate?api-version=3.0
    ...
    headers = {
        ...
        "Ocp-Apim-Subscription-Region": TRANSLATOR_REGION,  # tetap diperlukan untuk global endpoint
    ...
    try:
        async with httpx.AsyncClient(timeout=15) as client:
            ...
            # Jika Translator mengembalikan error (401/403/404/429/5xx), tampilkan detail aslinya
        ...
        # Network/timeout/error lain menuju service Translator
